...
imdb.expDir = ['/home/jobinkv/classification_rvlmodels/exp7_fullData32/',imdb.feature]; % 9--> 1:8k,10-->1:end
opts.useGpu = true;
...
for s = 1:length(imageSets),
    ...
    imageSetPath = fullfile('./labels/', sprintf('%s.txt',imageSets{s}));
